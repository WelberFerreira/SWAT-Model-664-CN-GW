...
!!    arrays which contain data related to HRUs
      ...
      allocate (bw1(mhru))
      allocate (bw2(mhru))
      allocate (cn_alpha(mhru)) !! Inserted by Welber
      allocate (cn_beta(mhru))  !! Inserted by Welber
      allocate (cn_lambda(mhru))  !! Inserted by Welber
      allocate (canmx(mhru))
...
!    Drainmod tile equations  01/2006
      ...
      allocate (delay(mhru))
      allocate (gw_delay_min(mhru)) !! New variables, inserted by welber
      allocate (gw_delay_max(mhru)) !! New variables, inserted by welber
      allocate (gw_d_max_day(mhru)) !! New variables, inserted by welber
