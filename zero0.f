...
!    Drainmod tile equations  01/2006
      ...
      delay = 0.
      depimp_bsn = 0.
      gw_delay_min = 0. !! New variables, inserted by welber
      gw_delay_max = 0. !! New variables, inserted by welber
      gw_d_max_day = 0. !! New variables, inserted by welber
      mo_ctrl = 0       !! New variables, inserted by welber
      yres_s_cons = 0   !! New variables, inserted by welber
      res_cons = 0.     !! New variables, inserted by welber
      dep_imp = 0.
      deptil = 0.
      det_san = 0.
      det_sil = 0.
      det_cla = 0.
      det_sag = 0.
      cn_alpha = 0.5 !! New variables, inserted by welber
      cn_beta = 1.5 !! New variables, inserted by welber
      cn_lambda = 0.!! New variables, inserted by welber
      det_lag = 0.
      dewpt = 0.
      dirtmx = 0.
      dis_stream = 0.
