...
!! calculate water balance for day
      ...
      !! new approach for reservoir
      !! discount water consume daily
      !!if (iyr == yres_s_cons  .or. iyr >= yres_s_cons) then
       !! If (mo_ctrl == 0 .or. mo_ctrl /= i_mo) then
         !! read (199,*) res_cons
         !! mo_ctrl = i_mo
          
          !!res_cons = res_cons * 86400  !! uncomment case data is cms
          
          !!print *, "---------------- "
          !!print *, "mo_ctrl = ", mo_ctrl
          !!print *, "res_cons =", res_cons
          !!print *, "yres_s_cons", yres_s_cons
          !!print *, res_vol(jres)
