...
!    Drainmod tile equations  01/2006
      ...
      real :: drain_co_bsn, pc_bsn, latksatf_bsn, res_cons !! welber
!    Drainmod tile equations  01/2006
...
!    Drainmod tile equations  01/2006
      ...
      integer :: no_lup, no_up, nostep, mo_ctrl, yres_s_cons  !! welber
...
! mhru = maximum number of hydrologic response units
      ...
      real, dimension (:), allocatable :: cn_alpha,cn_beta, cn_lambda !! Inserted by welber
...
!    Drainmod tile equations  08/2006
      ...
      real, dimension (:), allocatable :: gw_delay_min,gw_delay_max !! Inserted by Welber
      real, dimension (:), allocatable :: gw_d_max_day              !! Inserted by Welber
